...
public class HttpInputStream extends BufferedInputStream {
	...
	/**
	 * Parses an HTTP request, storing the method, request, and version in the
	 * object.
	 * */
	...
	protected void parseRequest(String request) throws HttpException {
		...
		if (request.startsWith("http://")) {
			...
			int pathIdx = request.indexOf('/', 7); // the slash after the
													// hostname
	...
	/*
	 * Returns the request's method. 150
	 */
