...
public class HttpOutputStream extends BufferedOutputStream {
	...
	/**
	 * Sends the HTTP headers that have been initialized with the setCode() and
	 * setHeadero methods and then returns whether the caller should send a
	 * subsequent body. If not, 50 " it will be because this is a head request
	 * and no body is required.
	 */
	...
	/**
	 * Writes a line of text. Coverts the String into an array of bytes in ISO
	 * Latin 1 encoding and writes these raw bytes to the attached stream.
	 */
